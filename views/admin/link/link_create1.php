...
<h1 class="text-center font-serif text-3xl md:text-5xl mb-5 text-[#ffe9a3] [text-shadow:0_0_12px_black]">Créer un lien entre chapitres</h1>

</div>
<label class="block font-serif text-lg mb-1">Choisir le chapitre source :</label>
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
    <?php foreach ($chapters as $c): ?>
        <a class="bg-black/50 border-[3px] border-[#8f6a1b] rounded-xl p-5 text-center text-[#ffe9a3] no-underline transition hover:scale-[1.02] hover:shadow-[0_0_18px_rgba(255,200,80,0.4)] cursor-pointer" href="create?from=<?= $c['id'] ?>">
